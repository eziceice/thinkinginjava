...
public class BlipCheck{
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("src/thinkinginjava/res/out.java"));
        out.writeObject(blip1);
        out.writeObject(blip2);
        out.close();

        ObjectInputStream in = new ObjectInputStream(new FileInputStream("src/thinkinginjava/res/out.java"));
