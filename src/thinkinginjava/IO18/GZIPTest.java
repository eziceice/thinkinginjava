...
public class GZIPTest {
    public static void main(String[] args) throws IOException {
        BufferedReader bufferedReader = new BufferedReader(new FileReader("src/thinkinginjava/res/test.txt"));
        BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(
                new GZIPOutputStream(new FileOutputStream("src/thinkinginjava/res/test.gz"))));
        String s;
        ...
        bufferedReader = new BufferedReader(new InputStreamReader(new GZIPInputStream(
                new FileInputStream("src/thinkinginjava/res/test.gz")
        )));
